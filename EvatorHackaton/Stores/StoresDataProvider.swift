...
final class StoresDataProvider: NSObject, DataProvider {
    ...
    func getData() -> [AnyObject]? {
        var cellModel = StoresModel(storeName: "Лавка Радости", address: "ул.Петрова,д3,к.2", workTime: "Пн-Вс 12-22", distance: "1,4 км")
        self.storesModels.append(cellModel)
        cellModel = StoresModel(storeName: "Кафейня Обаяние", address: "ул.Ленина,д4,к.1", workTime: "Пн-Вс 10-21", distance: "5 км")
        self.storesModels.append(cellModel)
